...
impl IranBypassConfig {
    ...
    pub fn recommended() -> Self {
        ...
        params.insert("url".to_string(), "https://meek.azurefd.net/".to_string());
        bridges.push(BridgeConfig {
            address: "20.186.13.205".to_string(),
            port: 443,
        ...
        bridges.push(BridgeConfig {
            address: "snowflake-broker.torproject.net".to_string(),
            port: 443,
        ...
        let mut obfs_params = HashMap::new();
        obfs_params.insert(
            "cert".to_string(),
            "qUVQ0srL1JI/vO6V6m/24anYXiJD3zP8o7ULQzu2RDy6GIVCbvGrDlhk9MhFBlRmFBMf+Q".to_string(),
        );
        obfs_params.insert("iat-mode".to_string(), "0".to_string());

        bridges.push(BridgeConfig {
            address: "192.95.36.142".to_string(),
            port: 443,
            protocol: ObfuscationProtocol::Obfs4,
            fingerprint: Some("CDF2E852BF539B82BD10E27E9115A31734E378C2".to_string()),
            extra_params: obfs_params,
            priority: 30,
        });
