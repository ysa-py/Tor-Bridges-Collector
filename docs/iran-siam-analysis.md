...
> آخرین بروزرسانی: `2026-08-02 22:50 UTC`  
> کل پل‌های تحلیل‌شده: **4**  
> میانگین امتیاز دور زدن: **91.5%**  
> بهترین امتیاز: **93.0%**
...
| 🕶️ STEALTH  | 1  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 0   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 0 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
