...
> آخرین بروزرسانی: `2026-08-20 02:03 UTC`  
> کل پل‌های تحلیل‌شده: **1543**  
> میانگین امتیاز دور زدن: **51.1%**  
> بهترین امتیاز: **93.0%**
...
| 🕶️ STEALTH  | 65  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 1004   | متوسط — از ۴-۵ لایه عبور می‌کند |
