...
> آخرین بروزرسانی: `2026-09-21 03:27 UTC`  
> کل پل‌های تحلیل‌شده: **1700**  
> میانگین امتیاز دور زدن: **51.9%**  
> بهترین امتیاز: **93.0%**
...
| 🥷 COVERT   | 1146   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 482 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
