...
> آخرین بروزرسانی: `2026-09-12 17:58 UTC`  
> کل پل‌های تحلیل‌شده: **1647**  
> میانگین امتیاز دور زدن: **51.8%**  
> بهترین امتیاز: **93.0%**
...
| 🕶️ STEALTH  | 68  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 1101   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 474 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
