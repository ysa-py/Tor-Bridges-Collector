...
> آخرین بروزرسانی: `2026-08-05 17:49 UTC`  
> کل پل‌های تحلیل‌شده: **1373**  
> میانگین امتیاز دور زدن: **49.7%**  
> بهترین امتیاز: **93.0%**
...
| 🕶️ STEALTH  | 54  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 852   | متوسط — از ۴-۵ لایه عبور می‌کند |
