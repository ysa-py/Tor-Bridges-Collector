...
> آخرین بروزرسانی: `2026-08-19 07:38 UTC`  
> کل پل‌های تحلیل‌شده: **1538**  
...
| 🕶️ STEALTH  | 64  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 1000   | متوسط — از ۴-۵ لایه عبور می‌کند |
