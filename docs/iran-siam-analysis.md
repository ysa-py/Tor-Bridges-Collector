...
> آخرین بروزرسانی: `2026-08-23 02:10 UTC`  
> کل پل‌های تحلیل‌شده: **1569**  
> میانگین امتیاز دور زدن: **51.3%**  
> بهترین امتیاز: **93.0%**
...
| 🕶️ STEALTH  | 66  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 1029   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 470 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
