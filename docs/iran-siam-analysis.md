...
> آخرین بروزرسانی: `2026-09-26 16:01 UTC`  
> کل پل‌های تحلیل‌شده: **1731**  
> میانگین امتیاز دور زدن: **52.1%**  
> بهترین امتیاز: **93.0%**
...
| 🥷 COVERT   | 1174   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 485 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
