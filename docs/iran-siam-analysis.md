...
> آخرین بروزرسانی: `2026-09-24 14:20 UTC`  
> کل پل‌های تحلیل‌شده: **1713**  
> میانگین امتیاز دور زدن: **52.0%**  
> بهترین امتیاز: **93.0%**
...
| 🥷 COVERT   | 1157   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 484 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
