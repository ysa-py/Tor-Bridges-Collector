...
> آخرین بروزرسانی: `2026-08-25 04:50 UTC`  
> کل پل‌های تحلیل‌شده: **1589**  
> میانگین امتیاز دور زدن: **51.5%**  
> بهترین امتیاز: **93.0%**
...
| 🥷 COVERT   | 1048   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 471 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
