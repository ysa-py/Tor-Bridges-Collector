...
> آخرین بروزرسانی: `2026-08-03 18:20 UTC`  
> کل پل‌های تحلیل‌شده: **1584**  
> میانگین امتیاز دور زدن: **54.7%**  
> بهترین امتیاز: **93.0%**
...
| :--- | :---: | :--- |
| 👻 PHANTOM  | 3  | کاملاً ناشناس — سیستم SIAM هیچ سیگنالی دریافت نمی‌کند |
| 🕶️ STEALTH  | 266  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 853   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 462 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
