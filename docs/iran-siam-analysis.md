...
> آخرین بروزرسانی: `2026-08-16 22:17 UTC`  
> کل پل‌های تحلیل‌شده: **1516**  
> میانگین امتیاز دور زدن: **50.9%**  
> بهترین امتیاز: **93.0%**
...
| 🕶️ STEALTH  | 63  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 980   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 469 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
