...
> آخرین بروزرسانی: `2026-08-14 22:25 UTC`  
> کل پل‌های تحلیل‌شده: **1493**  
> میانگین امتیاز دور زدن: **50.8%**  
> بهترین امتیاز: **93.0%**
...
| 🕶️ STEALTH  | 61  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 961   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 467 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
