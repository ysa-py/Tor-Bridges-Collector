...
> آخرین بروزرسانی: `2026-08-04 07:38 UTC`  
> کل پل‌های تحلیل‌شده: **1586**  
> میانگین امتیاز دور زدن: **54.8%**  
> بهترین امتیاز: **93.0%**
...
| 🕶️ STEALTH  | 267  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 854   | متوسط — از ۴-۵ لایه عبور می‌کند |
