...
> آخرین بروزرسانی: `2026-08-14 05:45 UTC`  
> کل پل‌های تحلیل‌شده: **1486**  
...
| 🕶️ STEALTH  | 60  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 955   | متوسط — از ۴-۵ لایه عبور می‌کند |
