...
> آخرین بروزرسانی: `2026-08-13 07:20 UTC`  
> کل پل‌های تحلیل‌شده: **1478**  
> میانگین امتیاز دور زدن: **50.6%**  
> بهترین امتیاز: **93.0%**
...
| 🕶️ STEALTH  | 59  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 948   | متوسط — از ۴-۵ لایه عبور می‌کند |
