...
> آخرین بروزرسانی: `2026-08-15 04:35 UTC`  
> کل پل‌های تحلیل‌شده: **1501**  
...
| 🕶️ STEALTH  | 62  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 966   | متوسط — از ۴-۵ لایه عبور می‌کند |
