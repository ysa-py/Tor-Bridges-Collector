...
> آخرین بروزرسانی: `2026-09-06 18:05 UTC`  
> کل پل‌های تحلیل‌شده: **1621**  
> میانگین امتیاز دور زدن: **51.6%**  
> بهترین امتیاز: **93.0%**
...
| 🕶️ STEALTH  | 67  | قوی — از ۶-۷ لایه از ۸ لایه عبور می‌کند |
| 🥷 COVERT   | 1077   | متوسط — از ۴-۵ لایه عبور می‌کند |
| ⚠️ EXPOSED  | 0  | ضعیف — اکثر لایه‌های SIAM تشخیص می‌دهند |
| 🚫 DETECTED | 473 | بلاک می‌شود — SIAM تشخیص کامل می‌دهد |
