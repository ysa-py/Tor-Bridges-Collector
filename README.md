...
**Last update:** `2026-08-01 23:30 UTC`
...
```
Use: bridge/iran_likely_working_all.txt    ← OONI-verified / TCP-test
...
| File | Bridges |
| :--- | :--- |
| [`iran_likely_working_all.txt`](bridge/iran_likely_working_all.txt) | 454 |
| [`iran_likely_working_obfs4.txt`](bridge/iran_likely_working_obfs4.txt) | 258 |
| [`iran_likely_working_webtunnel.txt`](bridge/iran_likely_working_webtunnel.txt) | 1 |
| [`iran_likely_working_snowflake.txt`](bridge/iran_likely_working_snowflake.txt) | 4 |

> **Note:** Files include OONI-confirmed bridges (Tier 1) and TCP-reachable bridges with no OONI data (Tier 2 fallback). WebTunnel bridges are nearly always Tier 2 because OONI measures by IP but WebTunnel uses HTTPS domains.
...
| File | Bridges |
| :--- | :--- |
| [`tested_global_obfs4.txt`](bridge/tested_global_obfs4.txt) | 258 |
| [`tested_global_webtunnel.txt`](bridge/tested_global_webtunnel.txt) | 1 |
| [`tested_global_vanilla.txt`](bridge/tested_global_vanilla.txt) | 191 |
